...
var app = (function () {
    ...
    function create_fragment$5(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(a, file$4, 41, 0, 1414);
    		},
    ...
    /* src/LandingPage.svelte generated by Svelte v3.59.2 */
    const file$2 = "src/LandingPage.svelte";

    // (64:4) <Link to ="/WhatsappChat">
    function create_default_slot$1(ctx) {
    	let t;

    	const block = {
    		c: function create() {
    			t = text("WhatsApp to Chat");
    		},
    		m: function mount(target, anchor) {
    	...
    	dispatch_dev("SvelteRegisterBlock", {
    		...
    		type: "slot",
    		source: "(64:4) <Link to =\\\"/WhatsappChat\\\">",
    		ctx
    	});
    ...
    function create_fragment$2(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			t0 = text("Welcome to ");
    			span = element("span");
    			span.textContent = "rojinphilip.com";
    			t2 = space();
    			div1 = element("div");
    			create_component(link.$$.fragment);
    			set_style(span, "color", "#007bff");
    			add_location(span, file$2, 58, 19, 871);
    			attr_dev(h1, "class", "svelte-1wulb1y");
    			add_location(h1, file$2, 58, 4, 856);
    			attr_dev(div0, "class", "content svelte-1wulb1y");
    			add_location(div0, file$2, 57, 2, 830);
    			attr_dev(div1, "class", "links svelte-1wulb1y");
    			add_location(div1, file$2, 62, 2, 976);
    			attr_dev(div2, "class", "container svelte-1wulb1y");
    			add_location(div2, file$2, 56, 0, 804);
    		},
    		l: function claim(nodes) {
    			throw new Error("options.hydrate only works if the component was compiled with the `hydratable: true` option");
    		},
    ...
    /* src/WhatsappChat.svelte generated by Svelte v3.59.2 */
    const file$1 = "src/WhatsappChat.svelte";

    // (99:4) {#if whatsappLink}
    function create_if_block(ctx) {
    	...
    	const block = {
    		c: function create() {
    			p = element("p");
    			t0 = text("WhatsApp Chat Link: ");
    			a = element("a");
    			t1 = text(/*whatsappLink*/ ctx[1]);
    			attr_dev(a, "href", /*whatsappLink*/ ctx[1]);
    			attr_dev(a, "target", "_blank");
    			add_location(a, file$1, 100, 28, 2126);
    			add_location(p, file$1, 99, 6, 2094);
    		},
    		m: function mount(target, anchor) {
    		...
    		p: function update(ctx, dirty) {
    			if (dirty & /*whatsappLink*/ 2) set_data_dev(t1, /*whatsappLink*/ ctx[1]);

    			if (dirty & /*whatsappLink*/ 2) {
    				attr_dev(a, "href", /*whatsappLink*/ ctx[1]);
    			}
    		},
    		d: function destroy(detaching) {
    ...
    function create_fragment$1(ctx) {
    	...
    	let mounted;
    	let dispose;
    	let if_block = /*whatsappLink*/ ctx[1] && create_if_block(ctx);

    	const block = {
    		c: function create() {
    			div3 = element("div");
    			div1 = element("div");
    			t0 = text("Chat without Saving\n    ");
    			span = element("span");
    			span.textContent = "?";
    			t2 = space();
    			div0 = element("div");
    			p0 = element("p");
    			p0.textContent = "1. Enter the unsaved phone number and click on the 'chat' button";
    			t4 = space();
    			p1 = element("p");
    			p1.textContent = "2. Click on the Whatsapp link generated to start chatting";
    			t6 = space();
    			div2 = element("div");
    			input = element("input");
    			t7 = space();
    			...
    			t9 = space();
    			if (if_block) if_block.c();
    			attr_dev(span, "class", "help-icon svelte-19n9i64");
    			add_location(span, file$1, 86, 4, 1569);
    			add_location(p0, file$1, 88, 6, 1723);
    			add_location(p1, file$1, 89, 6, 1801);
    			attr_dev(div0, "class", "help-message svelte-19n9i64");
    			toggle_class(div0, "show", /*showHelpMessage*/ ctx[2]);
    			add_location(div0, file$1, 87, 4, 1661);
    			attr_dev(div1, "class", "top-banner svelte-19n9i64");
    			add_location(div1, file$1, 84, 2, 1516);
    			attr_dev(input, "type", "tel");
    			attr_dev(input, "id", "phoneNumber");
    			attr_dev(input, "placeholder", "Enter phone number");
    			attr_dev(input, "class", "svelte-19n9i64");
    			add_location(input, file$1, 94, 4, 1917);
    			attr_dev(button, "class", "svelte-19n9i64");
    			add_location(button, file$1, 96, 4, 2018);
    			attr_dev(div2, "class", "container svelte-19n9i64");
    			add_location(div2, file$1, 93, 2, 1889);
    			add_location(div3, file$1, 83, 0, 1508);
    		},
    		l: function claim(nodes) {
    			throw new Error("options.hydrate only works if the component was compiled with the `hydratable: true` option");
    		},
    		m: function mount(target, anchor) {
    			...
    			set_input_value(input, /*phoneNumber*/ ctx[0]);
    			append_dev(div2, t7);
    			...
    			if (!mounted) {
    				dispose = [
    					listen_dev(span, "keypress", /*keypress_handler*/ ctx[4], false, false, false, false),
    					listen_dev(input, "input", /*input_input_handler*/ ctx[5]),
    					listen_dev(button, "click", /*generateLink*/ ctx[3], false, false, false, false)
    				];
    		...
    		p: function update(ctx, [dirty]) {
    			if (dirty & /*showHelpMessage*/ 4) {
    				toggle_class(div0, "show", /*showHelpMessage*/ ctx[2]);
    			}

    			if (dirty & /*phoneNumber*/ 1) {
    				set_input_value(input, /*phoneNumber*/ ctx[0]);
    			}

    			if (/*whatsappLink*/ ctx[1]) {
    				if (if_block) {
    					if_block.p(ctx, dirty);
    				} else {
    ...
    function instance$1($$self, $$props, $$invalidate) {
    	let { $$slots: slots = {}, $$scope } = $$props;
    	validate_slots('WhatsappChat', slots, []);
    	let phoneNumber = '';
    	let whatsappLink = '';
    	...
    	function generateLink() {
    		...
    		$$invalidate(1, whatsappLink = `https://api.whatsapp.com/send?phone=${encodeURIComponent(phoneNumber)}`);
    	}

    	const writable_props = [];

    	Object.keys($$props).forEach(key => {
    		if (!~writable_props.indexOf(key) && key.slice(0, 2) !== '$$' && key !== 'slot') console.warn(`<WhatsappChat> was created with unknown prop '${key}'`);
    	});

    	const keypress_handler = () => $$invalidate(2, showHelpMessage = !showHelpMessage);

    	function input_input_handler() {
    		phoneNumber = this.value;
    		$$invalidate(0, phoneNumber);
    	}
    	...
    	$$self.$inject_state = $$props => {
    		if ('phoneNumber' in $$props) $$invalidate(0, phoneNumber = $$props.phoneNumber);
    		if ('whatsappLink' in $$props) $$invalidate(1, whatsappLink = $$props.whatsappLink);
    		if ('showHelpMessage' in $$props) $$invalidate(2, showHelpMessage = $$props.showHelpMessage);
    	};
    ...
    class WhatsappChat extends SvelteComponentDev {
    	constructor(options) {
    		super(options);
    ...
    // (11:8) <Link to="/WhatsappChat">
    function create_default_slot_1(ctx) {
    	let t;

    	const block = {
    		c: function create() {
    			t = text("Whatsapp Chat W/o Save");
    		},
    		m: function mount(target, anchor) {
    			insert_dev(target, t, anchor);
    		},
    	...
    	dispatch_dev("SvelteRegisterBlock", {
    		...
    		type: "slot",
    		source: "(11:8) <Link to=\\\"/WhatsappChat\\\">",
    		ctx
    	});
